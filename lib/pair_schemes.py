...
Make sure the metadata columns are the same as used in this script.
...
Schemes 4+ are not to be used. They are dodgy and have not been tested. 
They were designed for binding sites.
'''
...
def main():
    ...
    # subset the df to the emb_entries
