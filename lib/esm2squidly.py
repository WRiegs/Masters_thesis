'''
This script converts the raw ESM2 embeddings to Squidly embeddings and saves them in a new directory.

The subsequent embeddings can then be used to train an LSTM or XGBoost model in LSTM_trainer.py or XB_trainer.py.
'''
