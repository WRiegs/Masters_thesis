'''
Script used to gather all the results from the reproduced models and plot them in a multi-histogram plot with error bars for standard deviation

Sorry the paths are all specific to me.
'''
