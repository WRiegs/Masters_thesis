'''
Used to assign heatmap values to the B-factor column of a PDB file.

You can then open that pdb file in pymol and visualise the heatmap.

Go to colour on the show menu of the structure, and then colour by b-factor.
...
def main():
    ...
    with open("/scratch/project/squid/Case_study2/squidly_predictions/site_probs.pkl", 'rb') as f:
