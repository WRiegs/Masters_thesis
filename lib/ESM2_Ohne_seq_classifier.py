'''
This script trains an XGBoost using the raw ESM2 embeddings.

I've abandoned this for now. Might use later for further comparisons between raw and squidly embeddings.
