...
TEST_NAME="Reproduction_Dataset_${DATASET}_Scheme_${SCHEME}_SLIM_${SLIM}_${ESM2_MODEL}_$(date +"%Y-%m-%d_%H-%M-%S")"
...
sbatch <<- EOS
    ...
    python reproduce_squidly.py --scheme $SCHEME --dataset $DATASET --sample_limit $SLIM --reruns $REPS --esm2_model $ESM2_MODEL
