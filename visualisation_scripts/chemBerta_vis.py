'''
A script to visualise the ChemBerta embeddings using PCA -- Unfinished

I wanted to include this in the thesis but didn't have time.

Might be a good way to visualise the chemical embedding space of our sequences, and see if they cluster.
